...
### 在编辑器中启用自动加固/刚性连接/传输优先级/同载具互动等功能
设置 - 通用 - 打开「**高级调节**」
...
只有小绿人可以开关科研设备，**任意职业和等级**的小绿人都能部署，但特定职业的小绿人部署特定设备会有额外的加成。
#### 存储容器
SEQ-3 和 SEQ-9  
...
若版本号相差不过大，一般而言：
- 添加组件的 MOD：较大可能兼容（需更新其依赖的功能性 MOD）
- 添加功能的 MOD：较小可能兼容
